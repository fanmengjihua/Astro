import { n as createVNode, F as Fragment, ax as __astro_tag_component__ } from './astro/server_BChoP70d.mjs';
import { jsx, jsxs } from 'react/jsx-runtime';
import { useState, useEffect, useRef } from 'react';
import { h as humanize } from './Base_C-k3BF_h.mjs';
...
const Youtube = ({
  ...
  return /* @__PURE__ */ jsx("lite-youtube", { className: "rounded-lg", videoid: id, videotitle: title, ...rest });
};
...
const url = "/elements";
const file = "D:/Desk/JiaWeiDao/src/content/pages/elements.mdx";
...
Content.moduleId = "D:/Desk/JiaWeiDao/src/content/pages/elements.mdx";
